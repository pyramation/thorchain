...
export declare const LaunchStageSDKType: typeof LaunchStage;
export declare function launchStageFromJSON(object: any): LaunchStage;
export declare function launchStageToJSON(object: LaunchStage): string;
